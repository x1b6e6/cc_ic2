...
@TileEntityBind(name = "reactor",
				tileentity = TileEntityNuclearReactorElectric.class)
public class ReactorImpl extends InvertoryImpl {

	@PeripheralFunc
	public static Object[] getOut(TileEntityNuclearReactorElectric te,
	...
	@PeripheralFunc
	public static Object[] getHeat(TileEntityNuclearReactorElectric te,
								   IComputerAccess access, ILuaContext context,
								   Object[] args)
		throws NoSuchFieldException, IllegalAccessException {
	...
	@PeripheralFunc
	public static Object[] getFluidHot(TileEntityNuclearReactorElectric te,
	...
	@PeripheralFunc
	public static Object[] getFluidCold(TileEntityNuclearReactorElectric te,
										IComputerAccess access,
										ILuaContext context, Object[] args)
		throws NoSuchFieldException, IllegalAccessException {
	...
	@PeripheralFunc
	public static Object[] isActive(TileEntityNuclearReactorElectric te,
									IComputerAccess access, ILuaContext context,
									Object[] args)
		throws NoSuchFieldException, IllegalAccessException {
	...
	@PeripheralFunc
	public static Object[] getFuelRemaining(TileEntityNuclearReactorElectric te,
											IComputerAccess access,
											ILuaContext context, Object[] args)
		throws NoSuchFieldException, IllegalAccessException {
		int o = -1;
		...
		for (int i = 0; i < te.getSizeInventory(); i++) {
			...
			if (item instanceof IReactorComponent) {
				if (!((IReactorComponent)item).canStoreHeat(stack, te, 0, 0) &&
					item.isDamageable()) {
	...
	public static Object[] setStatePrototype(
		TileEntityNuclearReactorElectric te, IComputerAccess access,
		ILuaContext context, Object[] args)
		throws NoSuchFieldException, IllegalAccessException {
	...
	@PeripheralFunc
	public static Object[] hasDepleted(TileEntityNuclearReactorElectric te,
	...
	@PeripheralFunc
	public static Object[] getSizeInventory(TileEntityNuclearReactorElectric te,
	...
	@PeripheralFunc
	public static Object[] getStackInSlot(TileEntityNuclearReactorElectric te,
										  IComputerAccess computerAccess,
										  ILuaContext luaContext,
										  Object[] args) {
		if (args == null || args.length != 1 || args[0] == null ||
