...
@TileEntityBind(name = "heat_source", tileentity = TileEntityHeatSourceInventory.class)
public class HeatSourceImpl extends InvertoryImpl {
	@PeripheralFunc
	public static Object[] getTransmitHeat(TileEntityHeatSourceInventory te, IComputerAccess access,
	...
	@PeripheralFunc
	public static Object[] getMaxHeatEmittedPerTick(TileEntityHeatSourceInventory te, IComputerAccess computer,
			ILuaContext context, Object[] args) {
		return Utils.toArray(te.getMaxHeatEmittedPerTick());
	}

	@PeripheralFunc
	public static Object[] getHeatBuffer(TileEntityHeatSourceInventory te, IComputerAccess computerAccess,
