...
@TileEntityBind(name = "fluid_heat_generator", tileentity = TileEntityFluidHeatGenerator.class)
public class FluidHeatGeneratorImpl extends HeatSourceImpl {
	@PeripheralFunc
	public static Object[] getTankAmount(TileEntityFluidHeatGenerator te, IComputerAccess computer, ILuaContext context,
			Object[] args) {
		return Utils.toArray(te.getTankAmount());
	}

	@PeripheralFunc
	public static Object[] needsFluid(TileEntityFluidHeatGenerator te, IComputerAccess computer, ILuaContext context,
			Object[] args) {
