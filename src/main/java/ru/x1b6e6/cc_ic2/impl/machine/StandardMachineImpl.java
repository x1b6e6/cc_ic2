...
@TileEntityBind(name = "standard_machine", tileentity = TileEntityStandardMachine.class)
public class StandardMachineImpl extends ElectricMachineImpl {
	@PeripheralFunc
	public static Object[] getProgress(TileEntityStandardMachine<?, ?, ?> te, IComputerAccess computer,
			ILuaContext context, Object[] args) {
		return Utils.toArray(te.getProgress());
	}

	@PeripheralFunc
	public static Object[] getEnergy(TileEntityStandardMachine<?, ?, ?> te, IComputerAccess computer,
			ILuaContext context, Object[] args) {
		return Utils.toArray(te.getEnergy());
	}

	@PeripheralFunc
	public static Object[] getActive(TileEntityStandardMachine<?, ?, ?> te, IComputerAccess computer,
			ILuaContext context, Object[] args) {
