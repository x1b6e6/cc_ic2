...
@TileEntityBind(name = "liquid_heat_exchanger", tileentity = TileEntityLiquidHeatExchanger.class)
public class LiquidHeatExchangerImpl extends HeatSourceImpl {
	@PeripheralFunc
	public static Object[] getInputTank(TileEntityLiquidHeatExchanger te, IComputerAccess computer, ILuaContext context,
			Object[] args) {
		return Utils.getFluidInfo(te.getInputTank());
	}

	@PeripheralFunc
	public static Object[] getOutputTank(TileEntityLiquidHeatExchanger te, IComputerAccess computer,
