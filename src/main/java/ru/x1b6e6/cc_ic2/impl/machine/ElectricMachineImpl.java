...
@TileEntityBind(name = "electric_machine", tileentity = TileEntityElectricMachine.class)
public class ElectricMachineImpl extends InvertoryImpl {
	@PeripheralFunc
	public static Object[] getInputSlot(TileEntityElectricMachine te, IComputerAccess computer, ILuaContext context,
			Object[] args) {
