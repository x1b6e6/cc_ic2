...
@TileEntityBind(name = "steam_kinetic_generator",
				tileentity = TileEntitySteamKineticGenerator.class)
public class SteamKineticGeneratorImpl extends InvertoryImpl {
	@PeripheralFunc
	public static Object[] getOut(TileEntitySteamKineticGenerator te,
	...
	@PeripheralFunc
	public static Object[] hasTurbine(TileEntitySteamKineticGenerator te,
	...
	@PeripheralFunc
	public static Object[] isTurbineBlockedByWater(
		TileEntitySteamKineticGenerator te, IComputerAccess computer,
		ILuaContext context, Object[] args) {
		return Utils.toArray(te.isTurbineBlockedByWater());
	}

	@PeripheralFunc
	public static Object[] isVentingSteam(TileEntitySteamKineticGenerator te,
										  IComputerAccess computer,
										  ILuaContext context, Object[] args) {
	...
	@PeripheralFunc
	public static Object[] isThrottled(TileEntitySteamKineticGenerator te,
									   IComputerAccess computer,
									   ILuaContext context, Object[] args) {
