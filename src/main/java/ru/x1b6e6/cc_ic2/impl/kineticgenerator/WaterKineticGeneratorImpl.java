...
@TileEntityBind(name = "water_kinetic_generator", tileentity = TileEntityWaterKineticGenerator.class)
public class WaterKineticGeneratorImpl extends InvertoryImpl {
	@PeripheralFunc
	public static Object[] getKuOutput(TileEntityWaterKineticGenerator te, IComputerAccess computer,
			ILuaContext context, Object[] args) {
		return Utils.toArray(te.getKuOutput());
	}

	@PeripheralFunc
	public static Object[] getEfficiency(TileEntityWaterKineticGenerator te, IComputerAccess computer,
			ILuaContext context, Object[] args) {
		return Utils.toArray(te.getEfficiency());
	}

	@PeripheralFunc
	public static Object[] getRotor(TileEntityWaterKineticGenerator te, IComputerAccess computer, ILuaContext context,
			Object[] args) {
