...
@TileEntityBind(name = "conversion_generator",
				tileentity = TileEntityConversionGenerator.class)
public class ConversionGeneratorImpl extends InvertoryImpl {
	@PeripheralFunc
	public static Object[] getSourceTier(TileEntityConversionGenerator te,
										 IComputerAccess comAccess,
										 ILuaContext icoILuaContext,
										 Object[] args) {
		return Utils.toArray(te.getSourceTier());
	}

	@PeripheralFunc
	public static Object[] getProduction(TileEntityConversionGenerator te,
										 IComputerAccess comAccess,
										 ILuaContext icoILuaContext,
										 Object[] args) {
	...
	@PeripheralFunc
	public static Object[] getMaxProduction(TileEntityConversionGenerator te,
											IComputerAccess comAccess,
											ILuaContext icoILuaContext,
											Object[] args) {
