...
@TileEntityBind(name = "geo_generator", tileentity = TileEntityGeoGenerator.class)
public class GeoGeneratorImpl extends BaseGeneratorImpl {
	@PeripheralFunc
	public static Object[] getFluidSlot(TileEntityGeoGenerator te, IComputerAccess icoAccess, ILuaContext icoContext,
			Object[] args) {
		try {
