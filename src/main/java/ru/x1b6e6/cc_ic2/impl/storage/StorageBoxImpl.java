...
public class StorageBoxImpl extends InvertoryImpl {
	@PeripheralFunc
	public static Object[] getSizeInventory(TileEntityStorageBox te, IComputerAccess computerAccess,
			ILuaContext luaContext, Object[] args) {
		return Utils.toArray(te.getSizeInventory());
	}

	@PeripheralFunc
	public static Object[] getStackInSlot(TileEntityStorageBox te, IComputerAccess computerAccess,
			ILuaContext luaContext, Object[] args) {
	...
	@PeripheralFunc
	public static Object[] isEmpty(TileEntityStorageBox te, IComputerAccess computerAccess, ILuaContext luaContext,
			Object[] args) {
